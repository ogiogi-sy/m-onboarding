import { Check, Pencil, FileText, ChevronRight, CheckCircle2 } from 'lucide-react';
      ...
      content: (
        <div className="space-y-3 text-sm">
           <div className="flex justify-between">
            ...
            <span className="font-bold text-brand-navy capitalize">{state.tradingAddress?.type}</span>
          </div>
          <div className="flex justify-between">
            <span className="text-text-secondary font-medium">Address</span>
            <span className="font-bold text-brand-navy text-right max-w-[200px] truncate">
      ...
      content: (
        <div className="space-y-3 text-sm">
          {state.businessDetails && (
            <>
               <div className="flex justify-between">
                <span className="text-text-secondary font-medium">Turnover</span>
                <span className="font-bold text-brand-navy">{state.businessDetails.turnover}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-text-secondary font-medium">Employees</span>
                <span className="font-bold text-brand-navy">{state.businessDetails.employees}</span>
              </div>
               <div className="flex justify-between">
                <span className="text-text-secondary font-medium">Intl. Payments</span>
                <span className="font-bold text-brand-navy">{state.businessDetails.internationalPayments ? 'Yes' : 'No'}</span>
              </div>
               <div className="flex justify-between">
                <span className="text-text-secondary font-medium">Monthly Income</span>
                <span className="font-bold text-brand-navy">{state.businessDetails.monthlyIncome}</span>
              </div>
               <div className="flex justify-between">
                <span className="text-text-secondary font-medium">Website</span>
                <span className="font-bold text-brand-navy truncate max-w-[150px]">{state.businessDetails.website || '-'}</span>
              </div>
               <div className="flex justify-between">
                <span className="text-text-secondary font-medium">Cash Deposits</span>
                <span className="font-bold text-brand-navy">{state.businessDetails.cashDeposits}</span>
              </div>
            </>
          )}
        </div>
